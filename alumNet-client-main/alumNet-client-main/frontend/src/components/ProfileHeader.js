                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            <span className="text-orange-600 font-bold text-sm">ALUMNI</span>
                            <span className="text-orange-600 font-bold text-sm">ASSOCIATION</span>
                        </div>
            ...
            <div className="bg-black">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
                    <nav className="flex items-center gap-8 flex-1">
                        ...
                        <Link to="/events" className="text-white hover:text-gray-300 transition">Events</Link>
