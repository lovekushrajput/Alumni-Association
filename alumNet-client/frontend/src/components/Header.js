...
function Header() {
    ...
    return (
        <>
        <header className="fixed top-0 left-0 right-0 bg-gradient-to-r from-slate-900 via-slate-800 to-gray-900 shadow-xl z-50">
    ...
    return (
        <nav className="flex items-center space-x-1">
            ...
            <NavLink to="/login" className={navStyle}>
                ...
                <span className="bg-white/10 text-white px-4 py-2 rounded-full font-medium backdrop-blur-sm">
                    Connecting Alumni
                </span>
            </div>
        </nav>
...
function UserDropdown() {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown Menu */}
            {isOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-slate-800 text-white rounded-xl shadow-xl border border-white/10 py-2 z-50 backdrop-blur-sm">
                    {/* Profile Option */}
                    <button
                        onClick={handleProfileClick}
                        className="w-full px-4 py-3 text-left text-white hover:bg-white/5 flex items-center gap-3 transition-colors"
                    >
                        ...
                        <div>
                            ...
                            <div className="text-sm text-gray-300">View your profile</div>
                        </div>
                    </button>
